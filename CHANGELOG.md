...
- Released changelog on `master` no longer includes an empty `[Unreleased]` section
...
- Use fallback immediately if halfOpen call fails
- Preserve error through halfOpen state
